    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerRight}>
          ...
          <Text>Fecha: {data.fechaCreacion ? new Date(data.fechaCreacion).toLocaleDateString() : 'N/A'}</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>{data.responsable?.nombreCompleto || data.responsable?.username}</Text>
        </View>
        <View style={styles.row}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>{data.variable?.nombre}</Text>
        </View>
        <View style={styles.row}>
          ...
          <View style={styles.gallery}>
            {data.evidencias.map((foto, i) => (
              <View key={i} style={styles.imageContainer}>
                {/* React-PDF maneja URLs de Cloudinary directo */}
